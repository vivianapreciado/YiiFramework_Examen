...
<header id="header">
    ...
    echo Nav::widget([
        ...
        'items' => [
           ...
           // ['label' => 'Contactántenos', 'url' => ['/site/contact']],
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-6 text-center text-md-start">&copy; Yii Framework All Rights Reserved <?= date('Y') ?></div>
